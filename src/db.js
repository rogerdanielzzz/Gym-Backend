...
const { Costumer,Sale, Gym, Trainer, User, Payment, Paidamount, Plan, Checkin} = sequelize.models;


Costumer.hasMany(Sale)
Sale.belongsTo(Costumer)

Gym.hasMany(Costumer)
Costumer.belongsTo(Gym)

Gym.hasMany(Trainer)
Trainer.belongsTo(Gym)
...
Payment.hasMany(Paidamount)
Paidamount.belongsTo(Payment)
